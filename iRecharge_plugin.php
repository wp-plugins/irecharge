...
{
    wp_register_script('irecharge_pluginscript.js',plugins_url('irecharge/js/irecharge_pluginscript.js',_FILE_), array('jquery'));
    wp_register_script('irecharge_jquerycookie.js',plugins_url('irecharge/js/jquery_cookie.js',_FILE_), array('jquery'));
    wp_register_style( 'irecharge_pluginstyle.css', plugins_url('irecharge/css/irecharge_pluginstyle.css', _FILE_ ), array());
